...
**Turning it in**: You'll turn in a zip file via Canvas that contains (a) a pdf write-up of the answers to the specific questions described below and, (b) all your code, and (c) the other items described below.
